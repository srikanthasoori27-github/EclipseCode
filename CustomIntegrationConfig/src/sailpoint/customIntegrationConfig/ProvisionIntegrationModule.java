...
public class ProvisionIntegrationModule extends AbstractIntegrationExecutor
{
	...
	public ProvisioningResult provision(ProvisioningPlan plan) throws Exception 
	{
		...
		for(int i=0;i<accReqs.size();i++)
		{
			...
			//Generate the actions according the Operation. This one launches the workflow if the operation is create
	...
	// Modify the attribute values accordingly. Used dummy values to generate the workflow
