...
public class ResponseFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) throws IOException, ServletException {
		...
		try {
			 ...
			 logger.debug("The attributes list is "+attributesToHide);
	...
	private static String convertResponse(CharResponseWrapper wrapper, List<String> attributesToHide) throws ServletException {
		...
		logger.debug("New response is "+newResponse);
	...
	private static List getAttributesListToHide() throws GeneralException{
		logger.debug("--- getAttributesListToHide start ---");
		List attributesToHide = new ArrayList();
		try {
			...
			logger.error("Error happened in trySailPointContextAccess: " + e);
			throw new GeneralException(e);
		}
		logger.debug("--- attributesToHide  ---"+ attributesToHide);
		logger.debug("--- getAttributesListToHide end ---");
