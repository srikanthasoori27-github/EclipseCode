 ...
 */
@XMLClass
public class RpcResponse extends AbstractXmlObject {
    ...
    public RpcResponse(String service, Map<String,Object> results) {
        this();
    ...
    public boolean hasMessages() {
        return ( ( _messages != null ) && ( _messages.size() > 0 ) ) ? true : false;
    }
