 ...
 *
 */
public class GroupDefinitionBean extends BaseObjectBean<GroupDefinition> 
	implements NavigationHistory.Page{

    private static Log log = LogFactory.getLog(GroupDefinitionBean.class);

    public static final String GRID_STATE = "ipopsIdentitiesGridState";
    ...
    /**
     * The configured attributes we will display for the edit population grid.
     */
    List<ColumnConfig> _popColumns;
    
    /**
    *
    */
   public GroupDefinitionBean() {
       super();
    ...
    public int getCount() throws GeneralException {
        ...
        QueryOptions ops = new QueryOptions(def.getFilter());
        ops.setDistinct(true);
    ...
    private void setCurrentTab() {
		...
		Map session = getSessionScope();
		session.put("activeTab", "popsGrid");
    }
	...
	public List<ColumnConfig> getColumns() 
        ...
        if (_popColumns == null) {
            _popColumns = super.getUIConfig().getPopulationEditTableColumns();
            ...
            if(identityConfig!=null) {
                for(ColumnConfig column : _popColumns) {
	...
	public String getPageName() {
		return "Edit Population Page";
	}

	public String getNavigationString() {
		return "editGroupDefinition";
	}
