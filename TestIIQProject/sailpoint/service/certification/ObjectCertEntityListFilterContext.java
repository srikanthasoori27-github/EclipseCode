 ...
 */
public class ObjectCertEntityListFilterContext extends CertificationEntityListFilterContext {
    ...
    // Filters
    private static final String ACCOUNT_GROUP_FILTER = "accountGroup";
    private static final String SCHEMA_OBJECT_TYPE_FILTER = "schemaObjectType";
     ...
     */
    public ObjectCertEntityListFilterContext(String certificationId) {
    ...
    public List<ListFilterDTO> getObjectAttributeFilters(SailPointContext context, Locale locale) throws GeneralException {
        ...
        // Do not add identity or bundle attributes for any object based entity search, thus don't call the parent method.
