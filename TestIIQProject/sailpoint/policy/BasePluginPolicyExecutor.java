...
/**
 * Base class that a plugin policy executor implementation should
 * inherit from if it requires common functionality that plugin
 * policy executors may need such as getting a connection to
 * the plugins datasource or reading of plugin configuration values.
 *
 * @author Dustin Dobervich <dustin.dobervich@sailpoint.com>
 */
public abstract class BasePluginPolicyExecutor extends AbstractPolicyExecutor implements PluginContext {
