...
/**
 * @author srikanth.asoori
 *
 */
public class AccountReconReportGenerator extends SailPointDataSource<IdentityRequestItem>{
	
	    private static final Log log = LogFactory.getLog(AccountReconReportGenerator.class);
	    ...
	    public AccountReconReportGenerator(Locale locale, TimeZone timezone) {
	        super(locale, timezone);
	        try {
	            commentHelper = new LcmReportCommentHelper(getContext());
	        } catch (GeneralException e) {
	            throw new RuntimeException("Could not get Context in " + AccountReconReportGenerator.class.getSimpleName(), e);
	        }
	    }
